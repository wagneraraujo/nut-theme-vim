" Vim Color File
" Name: nut.vim
" Based On: Inspiration in nut theme
...
let g:colors_name='nut'
set background=dark

if !exists("g:nut_terminal_italics")
  let g:nut_terminal_italics = 0
endif

if !exists("g:nut_terminalcolors")
  let g:nut_termcolors = 256
endif

" == COLOR PALETTE == 
"
" TODO: Cterm values here are OG from Challenger Deep
let s:space = { "gui": "#121212", "cterm": "233", "cterm16": "NONE"}
let s:deep_space= { "gui": "#000000", "cterm": "232", "cterm16": "0"}
let s:eclipse = { "gui": "#191919", "cterm": "236", "cterm16": "2"}

let s:stardust = { "gui": "#cbe3e7", "cterm": "253", "cterm16": "7"}
let s:cosmos = { "gui": "#a6b3cc", "cterm": "252", "cterm16": "15"}

let s:red = { "gui": "#FB6C6D", "cterm": "204", "cterm16": "1"}
let s:dark_red = { "gui": "#F02E6E", "cterm": "203", "cterm16": "9"}

let s:green = { "gui": "#93DA49", "cterm": "120", "cterm16": "2"}
let s:dark_green = { "gui": "#62d196", "cterm": "119", "cterm16": "10"}

let s:yellow = { "gui": "#FBCD7A", "cterm": "228", "cterm16": "3"}
let s:dark_yellow = { "gui": "#F2B482", "cterm": "215", "cterm16": "11"}

let s:blue = { "gui": "#35C5CF", "cterm": "159", "cterm16": "4"}
let s:dark_blue = { "gui": "#65b2ff", "cterm": "75", "cterm16": "12"}

let s:purple = { "gui": "#BE0046", "cterm": "141", "cterm16": "5"}
let s:dark_purple = { "gui": "#a37acc", "cterm": "135", "cterm16": "13"}

let s:cyan = { "gui": "#79D7F7", "cterm": "122", "cterm16": "6"}
...
function! s:h(group, style)
  ...
  if g:nut_terminal_italics == 0 && has_key(a:style, "cterm") && a:style["cterm"] == "italic"
    unlet a:style.cterm
  endif
  if g:nut_termcolors == 16
